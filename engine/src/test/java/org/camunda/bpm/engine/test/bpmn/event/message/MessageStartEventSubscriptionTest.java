...
//  private static final String MODEL = "org/camunda/bpm/engine/test/bpmn/event/conditional/ConditionalStartEventTest.testStartInstanceWithTrueConditionalStartEvent.bpmn20.xml";
...
//  private static final String TRUE_CONDITION_PROCESS = "trueConditionProcess";
  ...
  @Test
  @Deployment(resources = SINGLE_MESSAGE_START_EVENT_XML)
